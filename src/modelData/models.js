...
const userListModel = async () => {
  try {
    const response = await fetch("https://y2y8tg-8081.csb.app/users/list");
    if (!response.ok) {
...
const userModel = async (userId) => {
  try {
    const response = await fetch(`https://y2y8tg-8081.csb.app/users/${userId}`);
    if (!response.ok) {
      throw new Error(`HTTP error! status: ${response.status}`);
    }
    const data = await response.json();
...
const photoOfUserModel = async (userId) => {
  try {
    const response = await fetch(
      `https://y2y8tg-8081.csb.app/photos/${userId}`
    );
    if (!response.ok) {
      throw new Error(`HTTP error! status: ${response.status}`);
    }
...
const schemaModel = async () => {
  try {
    const response = await fetch("https://y2y8tg-8081.csb.app/api/users/info");
    if (!response.ok) {
      throw new Error(`HTTP error! status: ${response.status}`);
    }
